...
Andes Digital was engaged by {cust} to assist with {description} which seeks to get deeper understanding about OpenShift technology to some groups under its organization.
