...
project or initiative that Andes Digital Consulting is supporting, spreadsheets
...
of where the document is kept by the customer.  Andes Digital does not and should not
host customer provided material; please do provide links to Andes Digital's Google
